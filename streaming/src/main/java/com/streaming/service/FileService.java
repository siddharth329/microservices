...
public class FileService {
    ...
    public File uploadFile(String name, MultipartFile uploadedFile) {
        ...
        fileProcessorQueue.sendRequestForFileResolutionProcessing(savedFile);
        this.sendRequestForFileSnapshotsProcessing(savedFile);

        return savedFile;
    }

    public void sendRequestForFileSnapshotsProcessing(File file) {
        //
    }
}
